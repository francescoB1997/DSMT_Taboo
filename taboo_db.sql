...
CREATE DATABASE `taboo` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `taboo`;
...
INSERT INTO `friendship` VALUES ('alex_cook','ella_miller'),('alex_cook','mia_brown'),('ella_miller','luke_smith'),('emma_taylor','owen_hall'),('jackson84','max_wilson'),('jackson84','sarah_johnson'),
                                ('fra','gsf'),('fra','noah_carter'),('fra','owen_hall'),('fra','zoe_jenkins'),
                                ('fra','alex_cook'),('fra','ella_miller'),('fra','mia_brown'),
                                ('fra','luke_smith'),('fra','emma_taylor'),('fra','max_wilson'),
                                ('gsf','luke_smith'),
                                ('max_wilson','emma_taylor'),('max_wilson','owen_hall'),('owen_hall','alex_cook'),('owen_hall','ella_miller'),('owen_hall','sarah_johnson'),('sarah_johnson','alex_cook'),('sarah_johnson','david_moore'),('sarah_johnson','jackson84'),('sophie_davis','david_moore'),('user123','jackson84'),('user456','lily22');
